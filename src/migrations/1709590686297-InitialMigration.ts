...
export class InitialMigration1709590686297 implements MigrationInterface {
    name = 'InitialMigration1709590686297'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."foods_conclusion_enum" AS ENUM('baixo', 'moderado', 'alto')`);
        await queryRunner.query(`CREATE TABLE "foods" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "weight" integer NOT NULL, "consumption_mode" character varying NOT NULL, "conclusion" "public"."foods_conclusion_enum" NOT NULL, "hipoglycemic" boolean NOT NULL, "highlight" boolean NOT NULL, "userId" uuid, CONSTRAINT "PK_0cc83421325632f61fa27a52b59" PRIMARY KEY ("id"))`);
