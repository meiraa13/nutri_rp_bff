...
export class InitialMigration1711394753872 implements MigrationInterface {
    name = 'InitialMigration1711394753872'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "foods" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "weight" integer NOT NULL, "side" character varying NOT NULL DEFAULT '', "weight_side" integer NOT NULL DEFAULT '0', "result" integer NOT NULL, "conclusion" character varying NOT NULL, "insta" character varying NOT NULL DEFAULT '', "hipoglycemic" boolean NOT NULL, "highlight" boolean NOT NULL, "userId" uuid, CONSTRAINT "PK_0cc83421325632f61fa27a52b59" PRIMARY KEY ("id"))`);
